        ...
        <div> 
            ...
            <div class="ml-[9vw] mr-[9vw] p-5 mb-4 border rounded-lg bg-gray-50 border-gray-700">
                ...
                <ol class="mt-3 divide-y divide-gray-700">
                    <li>
                        <a class="items-center block p-3 sm:flex hover:bg-gray-200">
        ...
        <body>
            <div class="h-[35vw] relative">
                ...
                <input class="sr-only peer" type="radio" name="carousel" id="carousel-1" checked />
                    <!-- content #1 -->
                    <div
                        class="w-[25vw] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-lg shadow-lg transition-all duration-300 opacity-0 peer-checked:opacity-100 peer-checked:z-10 z-0">
                        <img class="rounded-t-lg w-96 h-64" src="assets/Kolase 1.JPG" alt="" />
                        <div class="py-4 px-8">
                        ...
                        <div class="absolute top-1/2 w-full flex justify-between z-20">
                            <label for="carousel-6" class="inline-block text-red-600 cursor-pointer -translate-x-5 bg-white rounded-full shadow-md active:translate-y-0.5">
                ...
                <div class="">
                    ...
                    <div
                        class="w-[25vw] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-lg shadow-lg transition-all duration-300 opacity-0 peer-checked:opacity-100 peer-checked:z-10 z-0">
                        <img class="rounded-t-lg w-96 h-64" src="assets/Kolase 2.jpg" alt="" />
                        <div class="py-4 px-8">
                            <h1 class="hover:cursor-pointer mt-2 text-gray-900 font-bold text-2xl tracking-tight text-center">
                                OSIS Senior High School
                            </h1>
                            <p class="hover:cursor-pointer py-3 text-gray-600 leading-6 text-justify">
                                As a Secretary, i carry out various activities such as recording meeting results, recording incoming and outgoing letters, making proposals and accountability reports, etc.
                            </p>
                        </div>
                        <!-- controls -->
                        <div class="absolute top-1/2 w-full flex justify-between z-20">
                ...
                <div class="">
                    ...
                    <div
                        class="w-[25vw] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-lg shadow-lg transition-all duration-300 opacity-0 peer-checked:opacity-100 peer-checked:z-10 z-0">
                        <img class="rounded-t-lg w-96 h-64" src="assets/Kolase 3.jpg" alt="" />
                        <div class="py-4 px-8">
                            <h1 class="hover:cursor-pointer mt-2 text-gray-900 font-bold text-2xl tracking-tight text-center">
                                FPOD Sidoarjo
                            </h1>
                            <p class="hover:cursor-pointer py-3 text-gray-600 leading-6 text-justify">
                                As a Public Relation Division, i carry out various activities such as coordinating with the government, conveying information to schools, seeking partners, etc.
                            </p>
                        </div>
                        <!-- controls -->
                        <div class="absolute top-1/2 w-full flex justify-between z-20">
                            ...
                            <label for="carousel-4" class="inline-block text-blue-600 cursor-pointer translate-x-5 bg-white rounded-full shadow-md active:translate-y-0.5">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-8.707l-3-3a1 1 0 00-1.414 1.414L10.586 9H7a1 1 0 100 2h3.586l-1.293 1.293a1 1 0 101.414 1.414l3-3a1 1 0 000-1.414z" clip-rule="evenodd" />
                                </svg>
                            </label>
                ...
                <!-- fourth -->
                <div class="">
                    <input class="sr-only peer" type="radio" name="carousel" id="carousel-4" />
                    <!-- content #4 -->
                    <div
                        class="w-[25vw] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-lg shadow-lg transition-all duration-300 opacity-0 peer-checked:opacity-100 peer-checked:z-10 z-0">
                        <img class="rounded-t-lg w-96 h-64" src="assets/Kolase 4.jpg" alt="" />
                        <div class="py-4 px-8">
                            <h1 class="hover:cursor-pointer mt-2 text-gray-900 font-bold text-2xl tracking-tight text-center">
                                OSIS Junior High School
                            </h1>
                            <p class="hover:cursor-pointer py-3 text-gray-600 leading-6 text-justify">
                                As a Secretary, i carry out various activities such as independence day, heroes day, class meeting, birthday of the prophet Muhammad, LDKS, etc.
                            </p>
                        </div>
                        <!-- controls -->
                        <div class="absolute top-1/2 w-full flex justify-between z-20">
                            ...
                            <label for="carousel-5" class="inline-block text-red-600 cursor-pointer translate-x-5 bg-white rounded-full shadow-md active:translate-y-0.5">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-8.707l-3-3a1 1 0 00-1.414 1.414L10.586 9H7a1 1 0 100 2h3.586l-1.293 1.293a1 1 0 101.414 1.414l3-3a1 1 0 000-1.414z" clip-rule="evenodd" />
                                </svg>
                            </label>
                ...
                <div class="">
                    ...
                    <div
                        class="w-[25vw] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-lg shadow-lg transition-all duration-300 opacity-0 peer-checked:opacity-100 peer-checked:z-10 z-0">
                        <img class="rounded-t-lg w-96 h-64" src="assets/Kolase 5.jpg" alt="" />
                        <div class="py-4 px-8">
                            <h1 class="hover:cursor-pointer mt-2 text-gray-900 font-bold text-2xl tracking-tight text-center">
                                Creative Team RTB
                            </h1>
                            <p class="hover:cursor-pointer py-3 text-gray-600 leading-6 text-justify">
                                As a Head of Event Division, i carry out various activities such as independence day, live music festival, gymnastics together, welcoming new students, etc.
                            </p>
                        </div>
                        <!-- controls -->
                        <div class="absolute top-1/2 w-full flex justify-between z-20">
                            <label for="carousel-4" class="inline-block text-yellow-600 cursor-pointer -translate-x-5 bg-white rounded-full shadow-md active:translate-y-0.5">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm.707-10.293a1 1 0 00-1.414-1.414l-3 3a1 1 0 000 1.414l3 3a1 1 0 001.414-1.414L9.414 11H13a1 1 0 100-2H9.414l1.293-1.293z" clip-rule="evenodd" />
                                </svg>
                            </label>
                            <label for="carousel-6" class="inline-block text-yellow-600 cursor-pointer translate-x-5 bg-white rounded-full shadow-md active:translate-y-0.5">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-8.707l-3-3a1 1 0 00-1.414 1.414L10.586 9H7a1 1 0 100 2h3.586l-1.293 1.293a1 1 0 101.414 1.414l3-3a1 1 0 000-1.414z" clip-rule="evenodd" />
                                </svg>
                            </label>
                ...
                <!-- sixth -->
                <div class="">
                    <input class="sr-only peer" type="radio" name="carousel" id="carousel-6" />
                    <!-- content #6 -->
                    <div
                        class="w-[25vw] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-lg shadow-lg transition-all duration-300 opacity-0 peer-checked:opacity-100 peer-checked:z-10 z-0">
                        <img class="rounded-t-lg w-96 h-64" src="assets/Kolase 6.jpg" alt="" />
                        <div class="py-4 px-8">
                            <h1 class="hover:cursor-pointer mt-2 text-gray-900 font-bold text-2xl tracking-tight text-center">
                                Creative Team RTB
                            </h1>
                            <p class="hover:cursor-pointer py-3 text-gray-600 leading-6 text-justify">
                                As a Leader, i carry out various activities such as live music festival, sports league, youth oath commemoration, commemorate chinese new year, etc.
                            </p>
                        </div>
                        <!-- controls -->
                        <div class="absolute top-1/2 w-full flex justify-between z-20">
                            <label for="carousel-5" class="inline-block text-blue-600 cursor-pointer -translate-x-5 bg-white rounded-full shadow-md active:translate-y-0.5">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm.707-10.293a1 1 0 00-1.414-1.414l-3 3a1 1 0 000 1.414l3 3a1 1 0 001.414-1.414L9.414 11H13a1 1 0 100-2H9.414l1.293-1.293z" clip-rule="evenodd" />
                                </svg>
                            </label>
